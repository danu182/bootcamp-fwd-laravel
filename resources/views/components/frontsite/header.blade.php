...
<nav x-data="{ navbarMobileOpen: false }" class="bg-white">
    ...
    <div class="flex justify-between h-16">
        ...
        <div class="hidden lg:ml-6 lg:flex lg:space-x-12">
            ...
            <a
            href="{{ route('index') }}"
            class="{{ request()->is('/') ? "text-[#1E2B4F] relative after:absolute after:content-[''] after:border-b-2 after:border-[#0D63F5] after:w-8/12 after:-translate-x-1/2 after:bottom-3 after:left-1/2 font-semibold" : "inline-flex items-center px-1 text-lg"}}">
            Home
            </a>
            <a
            href="#"
