                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="{{ route("backsite.doctor.update", $doctor2) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('specialist_id') ? 'has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <select name="specialist_id"
                                                                    ...
                                                                    <option value="{{ $doctor2->specialist_id }}">{{ $doctor2->specialist->name }}</option>
                                                                @foreach($specialist as $specialist_item)
                                                                    {{-- <option value="{{ $specialist_item->id }}">{{ $specialist_item->name }}</option>  --}}
                                                                 <option value="{{ $specialist_item->id }}" {{ $doctor2->specialist->specialist_id == $specialist_item->id ? 'selected' : '' }}>{{ $specialist_item->name }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="example dentist or dermatology" value="{{ $doctor2->name  }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="fee" name="fee" class="form-control" placeholder="example fee 10000" value="{{ old('fee', isset($specialist) ? $doctor2->fee : '') }}" autocomplete="off" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': 0, 'prefix': 'IDR ', 'placeholder': '0'" required>
